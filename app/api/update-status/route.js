...
<tr><td style="padding:28px 32px;text-align:center">
  <div style="display:inline-block;background:#f0fdf4;border:1.5px solid #86efac;border-radius:10px;padding:12px 28px;margin-bottom:20px">
    <div style="font-size:11px;color:#6b7280;letter-spacing:.8px;text-transform:uppercase;margin-bottom:4px">Ticket ID</div>
    <div style="font-size:22px;font-weight:700;color:#10b981;letter-spacing:2px;font-family:monospace">${ticketId}</div>
  </div>
